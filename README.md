...
Text-version and GUI-verision are compressed as "Demo3.zip" in this git.
...
## How to start text-version:
    ...
    3. Locate your position into "Demo3" folder in your command terminal.

	4. Locate your position into "src" folder in your command terminal.

    5. Use command "java battleship.gui.GUIStarter" to run the game.
